...
# modifiquei aqui, inclui a variavel abaixo
myValidator=["phone","cep","cpf"] 
...
class AutoFormatTelephoneNumber:
    ...
    def field_filter(self, value, boolean):
        if self.validator and (self.validator in myValidator):
...
class MDTextField(
    ...
    # modifiquei aqui, inclui myValidator as options
    validator = OptionProperty(None, options=["date", "email", "time"]+myValidator)
    ...
    def set_text(self, instance_text_field, text: str) -> None:
        ...
        if self.validator:
            ...
            if self.validator in myValidator:  
    ...
    def _get_has_error(self) -> bool:
        ...
        if self.validator and (self.validator not in myValidator):
        #self.validator != "phone": -modifiquei aqui
